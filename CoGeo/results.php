...
while ($i <= 9) {
    $params = array(
        ...
        "ScanFilter" => array(
            ...
            "Buzz" => array(
                "AttributeValueList" => array(
                    array(TYPE::STRING => (string)($feeling2)),
                    array(TYPE::STRING => (string)($feeling2))
                ),
                "ComparisonOperator" => "BETWEEN"
            ),
            "Pump" => array(
                "AttributeValueList" => array(
                    array(TYPE::STRING => (string)($feeling3)),
                    array(TYPE::STRING => (string)($feeling3))
                ),
                "ComparisonOperator" => "BETWEEN"
            ),
            "Adventure" => array(
                "AttributeValueList" => array(
                    array(TYPE::STRING => (string)($feeling4)),
                    array(TYPE::STRING => (string)($feeling4))
                ),
                "ComparisonOperator" => "BETWEEN"
            ),
            "Bustle" => array(
                "AttributeValueList" => array(
                    array(TYPE::STRING => (string)($feeling5)),
                    array(TYPE::STRING => (string)($feeling5))
                ),
                "ComparisonOperator" => "BETWEEN"
            ),
            "LoveyDovey" => array(
                "AttributeValueList" => array(
                    array(TYPE::STRING => (string)($feeling6)),
                    array(TYPE::STRING => (string)($feeling6))
                ),
                "ComparisonOperator" => "BETWEEN"
            ),
            "Trackies" => array(
                "AttributeValueList" => array(
                    array(TYPE::STRING => (string)($feeling7)),
                    array(TYPE::STRING => (string)($feeling7))
                ),
                "ComparisonOperator" => "BETWEEN"
            ),
    ...
    for ($j = 0; $j < 9; $j++) {
        if ($items[$j]["PlaceReference"]["S"] != NULL) {
            array_push($itemToBeRetrieved, $items[$j]["PlaceReference"]["S"]);
        }
    }
    ...
    if (count($itemToBeRetrieved) > 8) break;
...
echo $photoReference_1;
echo "</br>";
echo $photoReference_2;
echo "</br>";
echo $photoReference_3;
echo "</br>";
echo $photoReference_4;
echo "</br>";
echo $photoReference_5;
echo "</br>";
echo $photoReference_6;
echo "</br>";
echo $photoReference_7;
echo "</br>";
echo $photoReference_8;
echo "</br>";
echo $photoReference_9;
echo "</br>";
